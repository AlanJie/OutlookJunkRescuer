...
namespace OutlookJunkRescuer
{
    internal sealed class DuplicateCleanupForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "多设备独立备份可能会产生良性重复副本。本维护工具将在保留 1 份法定有效副本的前提下，安全将多余副本移至 Duplicate Trash 软隔离目录。",
        ...
        private void BtnClean_Click(object sender, EventArgs e)
        {
            ...
            var confirm = MessageBox.Show(
                ...
                $"• 预计将 {totalRedundant} 份多余副本安全移动至「Junk Archive\\Duplicate Trash」目录。\n" +
            ...
            SetBusyState(true, "正在安全移动冗余副本至 Duplicate Trash...");
            ...
            try
            {
                ...
                MessageBox.Show(
                    $"重复副本清理完成！\n\n" +
                    $"• 成功移动至 Duplicate Trash: {result.MovedToTrash} 封\n" +
        ...
        private void BtnOpenTrash_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var trash = _archiveWriter.GetOrCreateDuplicateTrashFolder(_archiveFolder);
                if (trash != null)
                {
        ...
        private void BtnEmptyTrash_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                trash = _archiveWriter.GetOrCreateDuplicateTrashFolder(_archiveFolder);
                items = trash.Items;
